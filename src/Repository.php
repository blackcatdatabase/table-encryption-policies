...
use BlackCat\Database\Packages\EncryptionPolicies\Repository\EncryptionPolicyRepository as GeneratedRepository;
...
{
  private EncryptionPolicyRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof EncryptionPolicyRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected EncryptionPolicyRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\EncryptionPolicies\Dto\EncryptionPolicyDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\EncryptionPolicies\Dto\EncryptionPolicyDto|null { return $this->repo->getById($id, $asDto); }
