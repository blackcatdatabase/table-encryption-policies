...
{
    private EncryptionPolicyRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new EncryptionPolicyRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\EncryptionPolicies\Dto\EncryptionPolicyDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\EncryptionPolicies\Dto\EncryptionPolicyDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\EncryptionPolicies\Dto\EncryptionPolicyDto|null
    {
