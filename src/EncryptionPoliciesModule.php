...
final class EncryptionPoliciesModule implements ModuleInterface {
    public function name(): string { return 'table-encryption_policies'; }
    public function table(): string { return 'encryption_policies'; }
    ...
    public function uninstall(Database $db, SqlDialect $d): void {
        $view = 'v_encryption_policies_contract';
        if ($d->isMysql()) {
