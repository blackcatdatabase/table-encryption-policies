...
namespace BlackCat\Database\Packages\EncryptionPolicies\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO EncryptionPolicyDto:
 ...
 */
final class EncryptionPolicyDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'id' => 'id', 'policy_name' => 'policyName', 'mode' => 'mode', 'layer_selection' => 'layerSelection', 'min_layers' => 'minLayers', 'max_layers' => 'maxLayers', 'aad_template' => 'aadTemplate', 'notes' => 'notes', 'created_at' => 'createdAt' ];

    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'min_layers', 'max_layers' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [ 'aad_template' ];
    /** @var string[] */
     ...
     * @return EncryptionPolicyDto
     */
    public static function fromRow(array $row): EncryptionPolicyDto
    {
        /** @var EncryptionPolicyDto */
        return DtoHydrator::fromRow(
            EncryptionPolicyDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?EncryptionPolicyDto
    {
     ...
     *
     * @param EncryptionPolicyDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(EncryptionPolicyDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(EncryptionPolicyDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(EncryptionPolicyDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,EncryptionPolicyDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,EncryptionPolicyDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(EncryptionPolicyDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,EncryptionPolicyDto>
     */
