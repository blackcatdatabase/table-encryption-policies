...
final class Definitions {
    ...
    public static function uniqueKeys(): array { return [ [ 'policy_name' ], [ 'id' ] ]; }

    /** @return string[] JSON columns for casts/operations */
    public static function jsonColumns(): array { return [ 'aad_template' ]; }

    /** @return string[] List of numeric columns (generator heuristic; no runtime DB queries). */
    public static function intColumns(): array { return [ 'id', 'min_layers', 'max_layers' ]; }
