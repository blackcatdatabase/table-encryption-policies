...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'policy_name', 'mode', 'layer_selection', 'min_layers', 'max_layers', 'aad_template', 'notes', 'created_at' ];
    }
    ...
    {
        $x = [ 'id', 'policy_name', 'mode', 'layer_selection', 'min_layers', 'max_layers', 'notes', 'created_at' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\EncryptionPolicies\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\EncryptionPolicies\Definitions::softDeleteColumn();
