 ...
 * - whitelist LIKE:   [ 'policy_name', 'mode', 'layer_selection', 'notes' ]
 * Podporované tvary:
...
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        $allowed = array_fill_keys([ 'id', 'policy_name', 'mode', 'layer_selection', 'min_layers', 'max_layers', 'aad_template', 'notes', 'created_at' ], true);
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'policy_name', 'mode', 'layer_selection', 'min_layers', 'max_layers', 'aad_template', 'notes', 'created_at' ], true);
            $parts = [];
